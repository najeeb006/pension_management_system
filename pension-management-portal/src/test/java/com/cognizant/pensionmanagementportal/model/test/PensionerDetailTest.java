...
import com.cognizant.pensionmanagementportal.model.BankDetail;
...
public class PensionerDetailTest {
	...
	{
		PensionerDetail pensionDetail=new PensionerDetail("123456789012", "Najeeb","06-11-1999" , "PIYTH7890L",40000,12000, "family", new BankDetail("SBI", "1930232384", "public"));
		String adhaar = pensionDetail.getAadhaarNumber() ;
		assertEquals("123456789012", adhaar) ;
		assertEquals("Najeeb", pensionDetail.getName() ) ;
